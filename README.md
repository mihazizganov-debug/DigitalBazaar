...
- **Кеширование Redis:**                                    (новое)
  - Кеширование страниц товаров (15 минут)
  - Кеширование списка категорий
  - Кеширование товаров по категориям
...
│ ├── models.py                               # Модели БД
│ ├── forms.py                                # Формы для продуктов (валидация, стилизация) 
│ ├── admin.py                                # Регистрация моделей в админке
│ └── services.py                             # Сервисные функции (кеширование)   (новое)
│
...
Категории: http://127.0.0.1:8000/categories/

Товары по категории: http://127.0.0.1:8000/category/1/
...
redis-cli -n 1 KEYS "*"
redis-cli -n 1 TTL ":1:category_1_products"
